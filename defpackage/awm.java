...
public class awm extends LinearLayout {
    ...
    public awm(Context context, int i) {
        ...
        setDividerDrawable(context.getResources().getDrawable(com.harman.hkconnect.R.drawable.juke_divider));
    ...
    public void setDividerDrawable(Drawable drawable) {
        if (drawable == this.b) {
            mm.b("DIVIDER", "Divider == mDivider");
            if (drawable == null) {
                mm.b("DIVIDER", "Divider == null");
                return;
            }
            return;
        }
        ...
        if (drawable != null) {
            ...
            mm.b("DIVIDER", "Divider width is " + this.c);
        } else {
            this.c = 0;
            this.d = 0;
            mm.b("DIVIDER", "Divider height is 0");
        }
