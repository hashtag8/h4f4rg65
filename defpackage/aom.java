...
public class aom implements DragSortListView.i {
    private Bitmap a;
    private ImageView b;
    private int c = -16777216;
    private ListView d;

    public aom(ListView listView) {
        this.d = listView;
    }
    ...
    @Override // com.harman.hkconnect.settings.management.curstomerview.DragSortListView.i
    public View a(int i) {
