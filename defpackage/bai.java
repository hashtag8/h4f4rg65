...
public class bai implements AuthScheme {
    public static Pattern c = Pattern.compile("^OAuth (\\w+)$");
    public HashMap<String, String> a = new HashMap<>();
    public HttpParams b;
    private bab d;

    public bai(bab babVar, HttpParams httpParams) {
        this.d = babVar;
        this.b = httpParams;
    }
    ...
    public Header authenticate(Credentials credentials, HttpRequest httpRequest) {
        ...
        synchronized (bai.class) {
            bak bakVarH = this.d.h();
            if ((bakVarH == null || bakVarH.d() == null || bakVarH.d().equals(strA)) && this.d.b() == null) {
                try {
                    try {
                        this.d.a();
    ...
    static class b implements AuthSchemeFactory {
        ...
        public AuthScheme newInstance(HttpParams httpParams) {
            return new bai(this.a, httpParams);
        }
    }
