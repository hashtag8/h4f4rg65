...
final class beh implements Interpolator {
    ...
    public float getInterpolation(float f) {
        ...
        int iMin = Math.min((int) ((b.length - 1) * f), b.length - 2);
        return ((b[iMin + 1] - b[iMin]) * ((f - (iMin * c)) / c)) + b[iMin];
    }
}
