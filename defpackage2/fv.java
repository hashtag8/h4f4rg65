...
public abstract class fv extends BaseAdapter implements Filterable, fw.a {
    protected boolean a;
    protected boolean b;
    protected Cursor c;
    protected Context d;
    ...
    public fv(Context context, Cursor cursor, boolean z) {
    ...
    class b extends DataSetObserver {
        ...
        public void onInvalidated() {
            fv.this.a = false;
            fv.this.notifyDataSetInvalidated();
        }
    }
}
