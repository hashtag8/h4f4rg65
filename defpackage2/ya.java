...
public interface ya extends IInterface {
    ...
    public static abstract class a extends Binder implements ya {
        ...
        static class C0165a implements ya {
            private IBinder a;
        ...
        public static ya a(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ya)) ? new C0165a(iBinder) : (ya) iInterfaceQueryLocalInterface;
        }
