...
public interface wa extends IInterface {
    ...
    public static abstract class a extends Binder implements wa {
        ...
        static class C0160a implements wa {
            private IBinder a;
        ...
        public static wa a(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof wa)) ? new C0160a(iBinder) : (wa) iInterfaceQueryLocalInterface;
        }
