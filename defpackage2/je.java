...
class je {
    ...
    je(ProgressBar progressBar) {
        this.b = progressBar;
    }

    void a(AttributeSet attributeSet, int i) {
        ks ksVarA = ks.a(this.b.getContext(), attributeSet, a, i, 0);
        Drawable drawableB = ksVarA.b(0);
        if (drawableB != null) {
            this.b.setIndeterminateDrawable(a(drawableB));
        }
        Drawable drawableB2 = ksVarA.b(1);
        if (drawableB2 != null) {
    ...
    private Drawable a(Drawable drawable, boolean z) {
        if (drawable instanceof cx) {
            Drawable drawableA = ((cx) drawable).a();
            if (drawableA != null) {
                ((cx) drawable).a(a(drawableA, z));
            }
        } else {
