...
public interface yn extends IInterface {
    ...
    public static abstract class a extends Binder implements yn {

        /* JADX INFO: renamed from: yn$a$a, reason: collision with other inner class name */
        static class C0168a implements yn {
            private IBinder a;
        ...
        public static yn a(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof yn)) ? new C0168a(iBinder) : (yn) iInterfaceQueryLocalInterface;
        }
